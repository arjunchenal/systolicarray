...
begin
    ...
    begin
        ...
        for r in 0 to ROWS-1 loop
            if to_integer(unsigned(grid_out(r)(0))) /= EXP0 or
               to_integer(unsigned(grid_out(r)(1))) /= EXP1 or
               to_integer(unsigned(grid_out(r)(2))) /= EXP2 or
               to_integer(unsigned(grid_out(r)(3))) /= EXP3 then
                correct := false;
                report " " & integer'image(r) & " | "
                     ...
                     & integer'image(to_integer(unsigned(grid_out(r)(3)))) & " | FAIL";
            else
                report " " & integer'image(r) & " | "
                     & integer'image(to_integer(unsigned(grid_out(r)(0)))) & " | "
                     & integer'image(to_integer(unsigned(grid_out(r)(1)))) & " | "
                     & integer'image(to_integer(unsigned(grid_out(r)(2)))) & " | "
                     & integer'image(to_integer(unsigned(grid_out(r)(3)))) & " | PASS";
            end if;
        end loop;
